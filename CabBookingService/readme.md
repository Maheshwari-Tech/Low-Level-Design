...
* Register a rider. --> rider controller register()
* Register a driver/cab  --> cab controller register()
* Update a cab's location --> cab controller updateLocation(location, cabId)
* A driver can switch on/off his availability --> cab controller offline(cabId)
* A rider can book a cab --> rider controller -> book(from, to, .. )
